_addon.author   = 'Orignal Amaiya, This Branch Kosmos'
...
windower.register_event('load', function()
    windower.add_to_chat(200,'Welcome to Beadit! Please make sure to read the entire readme file')
    windower.add_to_chat(200,'If it is hanging or not working it is most likely due to a missing')
    windower.add_to_chat(200,'a required addon(s) the needed gearswap link is in README.md ! ')
	...
	windower.send_command('lua load enternity')
		coroutine.sleep(.05)
	windower.send_command('lua load gearswap')
		coroutine.sleep(.05)
	windower.send_command('lua load silmaril')
		coroutine.sleep(.05)
...
function zonezitah()
	...
	log('Dragon popped...')
	coroutine.sleep(1)
	windower.send_command('gs c cycle AutoWSMode')
	coroutine.sleep(1)
	fight_dragon()
	coroutine.sleep(15)
	windower.send_command('sm off')
	coroutine.sleep(15)
	windower.send_command('sm off')
